...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('jquery', 'http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js', array(), '1.9.1'); // jquery
        ...
        wp_register_script('jquerycookie', get_template_directory_uri() . '/js/lib/jquery.cookie.js', array(), '1.4.1'); // Jquery Cookie
...
function create_post_type_html5()
{
    ...
    register_post_type('product', // Register Custom Post Type
        ...
        'labels' => array(
            ...
            'search_items' => __('Search Product', 'html5blank'),
